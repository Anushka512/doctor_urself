...
const TestimonialsHeader = () => {
    return (
      <div className={`bg-cover	bg-no-repeat ${styles.bg3}`} >
...
<a href="#enroll" className="inline-block rounded-lg bg-gray-500 px-8 py-3 w-40 text-center text-sm font-semibold text-white hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50" aria-label="Enroll now">Enroll</a>
